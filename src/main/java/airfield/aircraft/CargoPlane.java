...
public class CargoPlane extends Aircraft implements CargoHandler {
    ...
    public CargoPlane(Registration registration, String model, String engineType, int numOfEngines, int maxFuelLevel, double maxCargoCapacity, AircraftType type) {
